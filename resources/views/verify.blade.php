...
<div class="row justify-content-center mt-3">
    <div class="col-md-4 col-md-offset-4">
        {{ Form::open(array('url' => route('authenticator.verify'), 'method' => 'POST')) }}
        ...
        @if(config('authenticator.logout_route_name'))
        ...
        @if(config('authenticator.logout_route_name'))
        <form id="logout-form" action="{{ route(config('authenticator.logout_route_name')) }}" method="POST" style="display: none;">
            {{ csrf_field() }}
        </form>
        @endif
